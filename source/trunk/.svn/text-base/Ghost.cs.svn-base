...
namespace XNAPacMan {
    ...
    public class Ghost {
        ...
        //Ghost Speed and associated methods
        private static int ghostSpeed = 12; //(13,11,12,12) Appears to go from right to left
        ...
        public static void IncreaseGhostSpeed()
        {
            if (ghostSpeed > 4)
            {
                ghostSpeed--;                    
        ...
        public static void DecreaseGhostSpeed()
        {
            if (ghostSpeed < 25)
            {
                ghostSpeed++;
