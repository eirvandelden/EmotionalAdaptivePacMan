...
namespace XNAPacMan
{
    ...
    public class LevelSelection : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            selection_ = 0;
            // show possible items to select
            items_ = new string[] { "Calibration", "Adaptive", "Return"};
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            else if (newPressedKeys.Contains(Keys.Enter) || bp == Constants.ds3Cross)
            {
                menuAction();
            }
        ...
        void menuAction()
        {
            ...
            {
                case ("Calibration"):
                    Game.Components.Add(new GameLoop(Game, Level.Mode.Calibration, new frmEvents().staticVar));
                    break;
                case ("Adaptive"):
                    Game.Components.Add(new GameLoop(Game, Level.Mode.Adaptive , new frmEvents().staticVar));
                    break;
                case ("Return"):
